...
// Returns true if the instruction in the opcode table has immediate label 
bool Instruction::getIMMLabel() {
    ...
    return opTable.isIMMLabel(myOpcode);
}

// Returns true if the instruction in the opcode table is memory type
bool Instruction::getMemoryType() {
    ...
    return opTable.isMemoryType(myOpcode);
}
